...
//! ********** DO NOT MODIFY THIS FILE (IT EXISTS FOR TESTING PURPOSES AND DEFINES AN INTERFACE) **************** //
...
public:
    ...
    virtual bool intersect(const Scene& scene, Ray& ray, HitData& hitInfo) const = 0;
