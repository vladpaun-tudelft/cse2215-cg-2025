...
// should leave alone, as it may break our tests. Please undo this change, or you may lose points.

static_assert(is_scene<Scene>,
    "You broke Scene. Unbreak it or fail tests!");
static_assert(is_render_state<RenderState>,
    "You broke RenderState. Unbreak it or fail tests!");
static_assert(is_features<Features>,
    "You broke Features. Unbreak it or fail tests!");
static_assert(is_bvh_interface<BVHInterface>,
    "You broke BVHInterface. Unbreak it or fail tests!");
static_assert(is_bvh_interface_node<BVHInterface::Node>,
    "You broke BVHInterface::Node. Unbreak it or fail tests!");
static_assert(is_bvh_interface_primitive<BVHInterface::Primitive>,
    "You broke BVHInterface::Primitive. Unbreak it or fail tests!");
static_assert(std::is_base_of_v<BVHInterface, BVH>,
    "You broke BVH's BVHInterface compliance. Unbreak it or fail tests!");
