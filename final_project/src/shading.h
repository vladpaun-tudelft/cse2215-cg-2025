...
glm::vec3 computeLambertianModel(RenderState &state, const glm::vec3 &cameraDirection, const glm::vec3 &lightDirection, const glm::vec3 &lightColor, const HitInfo &hitInfo, const glm::vec3 &kd);
...
glm::vec3 computePhongModel(RenderState &state, const glm::vec3 &cameraDirection, const glm::vec3 &lightDirection, const glm::vec3 &lightColor, const HitInfo &hitInfo, const glm::vec3 &kd);
...
// For a description of the method's arguments, refer to 'shading.cpp'
// This method is unit-tested, so do not change the function signature.
glm::vec3 computeBlinnPhongModel(RenderState &state, const glm::vec3 &cameraDirection, const glm::vec3 &lightDirection, const glm::vec3 &lightColor, const HitInfo &hitInfo, const glm::vec3 &kd);
...
struct LinearGradient {
  ...
  // components. If ti falls outside the gradient's smallest/largest components,
  // the nearest component color must be sampled.
  // This method is unit-tested, so do not change the function signature.
